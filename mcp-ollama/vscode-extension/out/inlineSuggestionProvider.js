...
exports.InlineSuggestionProvider = void 0;
...
class InlineSuggestionProvider {
    ...
    async provideInlineCompletionItems(document, position, context, token) {
        ...
        try {
            ...
            const items = finalSuggestions.map((suggestion, index) => {
            ...
            const items = fallbackSuggestions.map(suggestion => new vscode.InlineCompletionItem(suggestion, new vscode.Range(position, position)));
            console.log('SmartCode-AIAssist: Returning', items.length, 'fallback suggestions');
            return items;
        }
    }
    getTriggerKind(context) {
    ...
    generateSmartSuggestions(textBeforeCursor, language, contextCode) {
        const suggestions = [];
...
exports.InlineSuggestionProvider = InlineSuggestionProvider;
//# sourceMappingURL=inlineSuggestionProvider.js.map